...
<?php
	...
	$frame = $_POST["fname"];
	// STEP 18: Set a variable to capture the last name from the submitted form, using the POSt$_POST array and the lname value
	$lname = $_POST ["lname"];
	// STEP 20: Capture the Alert Settings from the submitted form, using the POSt$_POST array and the alert value
	$alert = $_POST["alert"];
